            ...
            child: Column(
              ...
              children: [
                FutureBuilder<dynamic>(
                  future: unsplashCall(
                    query: tripPageRecord.destination,
                  ),
                  builder: (context, snapshot) {
                    // Customize what your widget looks like when it's loading.
                    if (!snapshot.hasData) {
                ...
                Row(
                  ...
                  children: [
                    ...
                    FFButtonWidget(
                      onPressed: () async {
                        Navigator.pop(context);
                        await tripPageRecord.reference.delete();
                      },
                      text: 'Delete',
                      options: FFButtonOptions(
                        width: 130,
