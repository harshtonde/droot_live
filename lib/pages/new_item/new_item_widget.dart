              ...
              children: [
                Padding(
                  ...
                  child: Card(
                    ...
                    child: Padding(
                      padding:
                          EdgeInsetsDirectional.fromSTEB(15.0, 5.0, 15.0, 7.0),
                      child: Column(
                        mainAxisSize: MainAxisSize.max,
                    ...
                    FFButtonWidget(
                      onPressed: () async {
                        await ItemlistRecord.collection
                            .doc()
                            .set(createItemlistRecordData(
                              packedinbag: _model.checkboxListTileValue,
